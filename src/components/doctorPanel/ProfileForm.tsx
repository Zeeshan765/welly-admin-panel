...
//             <button
//               type="submit"
//               className="w-1/2 cursor-pointer flex justify-center items-center rounded-lg border border-primary bg-primary p-4 text-white transition hover:bg-opacity-90"
//             >
//               Add Profile
...
const ProfileForm = ({ handleProfile }: any) => {
  ...
  const onSubmit = async (values: any) => {
    await handleProfile(values);
    toast.success('Please Fill Consultation Form to Complete the Profile');
  };
