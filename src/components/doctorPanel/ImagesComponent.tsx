...
const ImagesComponent = ({
  ...
  const handleFileChange = async (event: any, type: any) => {
    ...
    try {
      ...
      const response = await apiService.postImage('upload/image', formData, {
        headers: {
  ...
  return (
    <>
      <div className="relative z-20 h-35 md:h-65">
        <img
          src={coverImageUrl ? coverImageUrl : CoverOne}
          alt="profile cover"
        ...
        <div className="absolute bottom-1 right-1 z-10 xsm:bottom-4 xsm:right-4">
          ...
          >
            ...
            {loading ? <Spinner className="w-4 h-4" /> : <span>Edit</span>}
          </label>
        </div>
      </div>
