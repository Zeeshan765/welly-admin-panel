...
const LoginForm = ({ loading, handleLogin }: LoginProps) => {
  // Validation
  ...
  return (
    <div className="rounded-sm  bg-transparent mt-10  dark:border-strokedark dark:bg-boxdark">
            ...
            <form onSubmit={formik.handleSubmit}>
              ...
              <div className="mb-5">
                <button
                  ...
                  rounded-lg border border-primary bg-primary p-4 text-white
